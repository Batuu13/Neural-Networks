...
module "jiko_asd_repo" {
    source = "./modules/freetrade_repository"

    repository_name        = "jiko-asd"
    repository_description = "A repo for JIKO"
...
resource "github_team_repository" "jiko_asd_team" {
    team_id    = var.engineering_team_slug
    repository = module.jiko_asd_repo.repository_name
    permission = "push"
}
